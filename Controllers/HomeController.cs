...
namespace WebApplication9.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        [Authorize]
        public ActionResult foundDates(String UserName, string searchString, string interestringString, string genderString, string sortOrder, string country, string state, string city, DateTime availableDate)
        {
            ...
            foreach (ClientDetailInfo client in clients)
            {
                ...
                if (client.client.availableDate ==availableDate)
                {
                    clientsHasAvail.Add(client);
                }
            }

            ViewBag.date = availableDate.ToShortDateString();
        ...
        [Authorize]
        [HttpPost]
        public ActionResult findADate(String userName, DateTime availableDate, String gender, String country, String state, String city)
        {
            repo.saveAvailableDate(userName, availableDate);

            return RedirectToAction("foundDates", new { UserName = userName, genderString = gender, Country = country, State = state, City = city, availableDate=availableDate
            });
